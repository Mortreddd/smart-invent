...
<main>
    <div style="width: 100%; max-width: 600px; margin: 0 auto; padding: 20px; background: #f3f4f6; border-radius: 14px;">
        ...
        <a style="display: block; padding: 10px 20px; background: #10b981; color: white; text-decoration: none; font-size: 18px; margin-left: auto; margin-right: auto; border-radius: 4px; transition: all;">Reset Password</a>
